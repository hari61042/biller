  ...
  <body>
      ...
      <br>
           <form role="form" method="POST" action="#">
                ...
                <div class="">
                    <label for="date" style="color:Tomato;" align="left">Select Required Bill Month:</label>  <br><br>
                    <select name="bMonth" id="month" style="width:40%;font-size:25px;">
...
<?php
    ...
    if(isset($_POST['getBill']))
    {
        ...
        {   
            ...
            echo "<h2 style='color:Tomato';>Selected Month</h2>";
            
            echo "\n$date\n\n<br><br>";
            $result = mysqli_query($conn,"SELECT * FROM bill where SUBSTR(date,6,2)='$date'");
            ...
            echo "<table border='2' id='customers'>
                    ...
                    while($row = mysqli_fetch_array($result))
                      ...
                      echo "<td style='text-align:center;' colspan='2'> Total Price </td>";
                      echo "<td style='text-align:right' >" . $sum . "</td>";
                      echo "</tr>";
            
                        echo "<tr>";
                        
                      echo "<td style='text-align:center;' colspan='2'> Price(per Each Person) </td>";
                      echo "<td style='text-align:right' >" . $sum/6 . "</td>";
                      echo "</tr>";
                    echo "</table>";
            $conn->close();
        }
